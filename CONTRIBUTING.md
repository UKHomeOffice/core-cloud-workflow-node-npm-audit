...
Contributing to `core-cloud-workflow-npm-audit`
...
* `action.yaml` — composite GitHub Action for running npm audit
...
* npm audit regression tests

* npm audit behaviour validation
